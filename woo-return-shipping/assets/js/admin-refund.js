                    ...
                    '<div style="display: flex; flex-direction: column; gap: 10px; margin-bottom: 10px;">' +
                        '<div style="display: flex; justify-content: space-between; align-items: center;">' +
                            ...
                            '<div style="display: flex; align-items: center;">' +
                                '<label class="screen-reader-text" for="wrs_return_shipping_fee">Return Shipping Fee</label>' +
                        ...
                        '<div style="display: flex; justify-content: space-between; align-items: center;">' +
                            ...
                            '</label>' +
                            '<div style="display: flex; align-items: center;">' +
                                '<label class="screen-reader-text" for="wrs_box_damage_fee">Retail Box Damage Fee</label>' +
                                '<span aria-hidden="true" style="color: #c00; font-weight: bold; margin-right: 4px;">-$</span>' +
