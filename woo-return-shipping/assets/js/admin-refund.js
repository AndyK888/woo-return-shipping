...
(function ($) {
    ...
    var WRS = {
        ...
        replaceAmountInLabel: function (label, formattedMoney, formattedNumber) {
            ...
            if (this._labelRegexes.symbolBefore.test(label)) {
                return label.replace(this._labelRegexes.symbolBefore, formattedMoney);
            }

            if (this._labelRegexes.symbolAfter.test(label)) {
                return label.replace(this._labelRegexes.symbolAfter, formattedMoney);
            }

            if (this._labelRegexes.amount.test(label)) {
                return label.replace(this._labelRegexes.amount, formattedNumber);
            }
